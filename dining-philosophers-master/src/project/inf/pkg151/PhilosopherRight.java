...
class PhilosopherRight extends Thread {
    ...
    public PhilosopherRight(Fork izq, Fork der, int num, JLabel E1, JLabel E2, JLabel E3, JLabel I, JLabel S) {
        forkLeft = izq;
        forkRight = der;
        this.number = num;
        this.E1 = E1;
    ...
    public void run() {
        for (int i = 1; i <= 3; i++) {
            ...
            try {
                ...
                Logger.getLogger(PhilosopherRight.class.getName()).log(Level.SEVERE, null, ex);
            }
